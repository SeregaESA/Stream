...
//
// Асимптотическая оценка алгоритмов (Большая О):
// О(n) - самая эффективная оценка. max n = 10 в 9 степени
// О(n * log n) - тоже не плохая. max n = 10 в 7.5 степени
// n в квадрате - плохая оценка. max n = 10 в 4.5 степени
// 2 в степени n - самая плохая и неприминимая на практике. max n = 30
//
