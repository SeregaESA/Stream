...
public class methodsMinAndMax {
    public static void main(String[] args) {
        ...
        StudentStream2 min = student2.stream().min(Comparator.comparingInt(StudentStream2::getAge)).get();
        System.out.println(min);

        StudentStream2 max = student2.stream().max(Comparator.comparingInt(StudentStream2::getAge)).get();
